<template>
    <div class="w-full pt-8 md:pt-14 px-6 md:px-14 xl:hidden">
        <GoBackButton @close="triggerCloseSidebar" />
    </div>
    <div class="flex-grow">
        <div class="min-h-full flex flex-wrap">
            <!-- form fields section -->
            <div class="py-7 md:py-12 px-6 md:px-14 basis-full">
                <EditHeader v-if="isEditMode" :invoice-id="invoiceId" />
                <AddHeader v-else />

                <div class="flex flex-col justify-start items-stretch mt-12">
                    <Heading
                        tag="h3"
                        size="s"
                    ...
                    />
                    <div
                        class="flex flex-wrap md:grid md:grid-cols-3 items-center justify-center md:gap-6 mt-6"
                    >
                        <Input
                        ...
                        <Input
                            ...
                            label="Post Code"
                            name="fromZip"
                            class="basis-1/2 md:basis-auto pl-3 md:pl-0"
                            :error-message="
                                v.fromZip.$errors.length ? v.fromZip.$errors[0].$message : null
                            "
                        />
                        <Input
                ...
                <div class="flex flex-col justify-start items-stretch mt-12">
                    ...
                    <Input
                        ...
                        class="mt-6"
                        :error-message="
                            v.toStreet.$errors.length ? v.toStreet.$errors[0].$message : null
                        "
                    />
                    <div
                        class="flex flex-wrap md:grid md:grid-cols-3 items-center justify-center md:gap-6 mt-6"
                    >
                        <Input
                            ...
                            class="basis-1/2 md:basis-auto pr-3 md:pr-0"
                            :error-message="
                                v.toCity.$errors.length ? v.toCity.$errors[0].$message : null
                            "
                        />
                        <Input
                            ...
                            class="basis-1/2 md:basis-auto pl-3 md:pl-0"
                            :error-message="
                                v.toZip.$errors.length ? v.toZip.$errors[0].$message : null
                            "
                        />
                        <Input
...
const removeItem = (itemId: string) => {
    const newItemList = invoiceForm.value.items.filter(
